...
```
npm install @rakuten-rex/form-group@0.0.1 --save
```
...
```
yarn add @rakuten-rex/form-group@0.0.1
```
...
```
https://unpkg.com/@rakuten-rex/form-group@0.0.1/FormGroup/FormGroup.production.min.css
```
...
```
https://unpkg.com/@rakuten-rex/form-group@0.0.1/FormGroup/FormGroup.development.css
```
...
```
https://unpkg.com/@rakuten-rex/form-group@0.0.1/FormGroup/FormGroup.static.css
```
...
<html>
  <head>
    ...
    <title>My Page</title>
    <!-- ReX form-group -->
    <link href="https://unpkg.com/@rakuten-rex/form-group@0.0.1/FormGroup/FormGroup.production.min.css" rel="stylesheet">
  </head>
  <body>
    <!-- inline layout -->
    <div class="rex-form-group rex-m-1">
